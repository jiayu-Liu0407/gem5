...
def dechunk_filled(
    filled: cpy.FillReturn, fill_type: FillType | str
) -> cpy.FillReturn:
    ...
    if fill_type == FillType.ChunkCombinedCode:
        ...
        if points is None:
            ret3: cpy.FillReturn_ChunkCombinedCodeOffset = (
                [None],
                [None],
                [None],
            )
        ...
        if points is None:
            ret4: cpy.FillReturn_ChunkCombinedOffsetOffset = (
                [None],
                [None],
                [None],
            )
            ...
            ret4 = (
                [points],
                [concat_offsets_or_none(filled[1])],
                [outer_offsets],
            )
        return ret4
    else:
...
def dechunk_lines(
    lines: cpy.LineReturn, line_type: LineType | str
) -> cpy.LineReturn:

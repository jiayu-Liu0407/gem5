...
def closure_glyphs(self, s):
    ...
    while decompose:
        ...
        for g in decompose:
            ...
            decompiler = _ClosureGlyphsT2Decompiler(
                components, subrs, gl.globalSubrs
            )
...
def subset_glyphs(self, s):
    ...
    for fontname in cff.keys():
        ...
        if cs.charStringsAreIndexed:
            ...
            cs.charStrings = {
                g: v for g, v in cs.charStrings.items() if g in glyphs
            }
...
@deprecateFunction(
    "use 'CFFFontSet.remove_unused_subroutines' instead",

...
def computeMegaCmap(merger, cmapTables):
    ...
    fontIndexForGlyph = {}
    glyphSets = (
        [None for f in merger.fonts] if hasattr(merger, "fonts") else None
    )
    ...
    for table, fontIdx in chosenCmapTables:
        ...
        for uni, gid in table.cmap.items():
            ...
            if oldgid is None:
            ...
            elif is_Default_Ignorable(uni) or uni in (
                0x25CC,
                ...
                if merger.duplicateGlyphsPerFont[fontIdx].get(oldgid) is None:
                    ...
                    log.warning(
                        "Dropped mapping from codepoint %#06X to glyphId '%s'",
                        uni,
                        gid,
                    )

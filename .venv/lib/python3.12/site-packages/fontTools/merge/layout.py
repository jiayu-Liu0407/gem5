...
otTables.FeatureList.mergeMap = {
    "FeatureCount": sum,
    "FeatureRecord": lambda lst: sorted(
        sumLists(lst), key=lambda s: s.FeatureTag
    ),
}
    ...
    for t in [GSUB, GPOS]:
        ...
        if t.table.LookupList:
            ...
            if (
                ...
                markFilteringSetMap = {
                    i: v
                    for i, v in enumerate(GDEF.table.MarkGlyphSetsDef.Coverage)
                }
                t.table.LookupList.mapMarkFilteringSets(markFilteringSetMap)

        if t.table.FeatureList and t.table.ScriptList:
            featureMap = {
                i: v for i, v in enumerate(t.table.FeatureList.FeatureRecord)
            }
...
def layoutPostMerge(font):
    ...
    for t in [GSUB, GPOS]:
        ...
        if t.table.FeatureList and t.table.ScriptList:
            ...
            featureMap = GregariousIdentityDict(
            ...
            t.table.FeatureList.FeatureCount = len(
                t.table.FeatureList.FeatureRecord
            )
        ...
        if t.table.LookupList:
            ...
            # Record used lookups.
            lookupMap = AttendanceRecordingIdentityDict(
            ...
            t.table.LookupList.Lookup = [
                l
                for i, l in enumerate(t.table.LookupList.Lookup)
                if i in usedIndices
            ]

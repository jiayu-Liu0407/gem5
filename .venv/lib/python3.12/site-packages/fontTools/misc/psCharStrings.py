...
def encodeFixed(f, pack=struct.pack):
    ...
    if value & 0xFFFF == 0:  # check if the fractional part is zero
        ...
        return b"\xff" + pack(
            ">l", value
        )  # encode the entire fixed point value
...
class T2WidthExtractor(SimpleT2Decompiler):
    def __init__(
        ...
        SimpleT2Decompiler.__init__(
            self, localSubrs, globalSubrs, private, blender
        )
...
class T2CharString(object):
    ...
    def __init__(
        self, bytecode=None, program=None, private=None, globalSubrs=None
    ):
        if program is None:
            program = []
    ...
    def decompile(self):
        ...
        decompiler = self.decompilerClass(
            subrs, self.globalSubrs, self.private
        )
...
class T1CharString(T2CharString):
    ...
    def getFixedEncoder(self):
        def encodeFixed(value):
            raise TypeError(
                "Type 1 charstrings don't support floating point operands"
            )

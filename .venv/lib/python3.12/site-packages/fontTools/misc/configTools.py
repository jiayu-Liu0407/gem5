...
class AbstractConfig(MutableMapping):
    ...
    def __init__(
        ...
        self._values = {}
        values_dict = (
            values._values if isinstance(values, AbstractConfig) else values
        )
    ...
    def get(
        self,
        option_or_name: Union[Option, str],
        default: Any = _USE_GLOBAL_DEFAULT,
    ) -> Any:
        """
    ...
    def __setitem__(
        self, option_or_name: Union[Option, str], value: Any
    ) -> None:

...
class PSOperators(object):
    ...
    def ps_put(self):
        ...
        if tp == "arraytype" or tp == "proceduretype":
            ...
            index = obj2.value
            obj3.value = (
                obj3.value[:index] + chr(obj1.value) + obj3.value[index + 1 :]
            )
    ...
    def ps_getinterval(self):
        ...
        if tp == "arraytype":
            self.push(
                ps_array(obj3.value[obj2.value : obj2.value + obj1.value])
            )
        elif tp == "stringtype":
            self.push(
                ps_string(obj3.value[obj2.value : obj2.value + obj1.value])
            )

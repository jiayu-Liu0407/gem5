...
class StatisticsBase:
    ...
    def _update(self):
        ...
        slant = (
            self.covariance / self.varianceY
            if self.varianceY != 0
            else float("NaN")
        )
    ...
    def _endPath(self):
        ...
        if p0 != self._startPoint:
            raise OpenContourError(
                "Glyph statistics not defined on open contours."
            )
        self._update()
...
def main(args):
    ...
    parser.add_argument(
        "glyphs", metavar="glyph-name", help="Glyph names.", nargs="*"
    )
    parser.add_argument(
        "-y",
        metavar="<number>",
    ...
    parser.add_argument(
        ...
        "--quiet",
        action="store_true",
        help="Only report font-wide statistics.",
    )
    parser.add_argument(
        "--variations",
        metavar="AXIS=LOC",

    ...
    while len(modules_queue) > 0:
        ...
        for member_name in dir(module):
            ...
            if (
                ...
                and "numpy._core"
                not in member.__name__  # not private  # outside _core
                and
    ...
    while len(modules_queue) > 0:
        ...
        for member_name in dir(module):
            ...
            if (
                ...
                if (
                    member.__name__ == "recarray"
                    and module.__name__ == "numpy"
                ) or (
                    member.__name__ == "record"
                    and module.__name__ == "numpy.rec"
                ):
                    continue
    ...
    while len(modules_queue) > 0:
        ...
        for member_name in dir(module):
            ...
            if (
                ...
                and member  # outside _core
                not in visited_modules  # not visited yet
            ):
                modules_queue.append(member)
                visited_modules.add(member)
            elif (

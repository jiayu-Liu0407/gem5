...
_ArrayT_co = TypeVar(
    "_ArrayT_co", bound=ndarray, default=ndarray, covariant=True
)
_IntegralArrayT = TypeVar(
    "_IntegralArrayT", bound=NDArray[integer | np.bool | object_]
)
_RealArrayT = TypeVar(
    "_RealArrayT",
    bound=NDArray[floating | integer | timedelta64 | np.bool | object_],
)
...
_ShapeT_co = TypeVar(
    "_ShapeT_co", bound=_Shape, default=_AnyShape, covariant=True
)
...
_ScalarT_co = TypeVar(
    "_ScalarT_co", bound=generic, default=Any, covariant=True
)
...
_IntegerT_co = TypeVar(
    "_IntegerT_co", bound=integer, default=integer, covariant=True
)
_NonObjectScalarT = TypeVar(
    "_NonObjectScalarT",
    bound=np.bool | number | flexible | datetime64 | timedelta64,
)
...
_BoolOrIntArrayT = TypeVar(
    "_BoolOrIntArrayT", bound=NDArray[integer | np.bool]
)
...
_DT64Date: TypeAlias = (
    _HasDateAttributes | L["TODAY", "today", b"TODAY", b"today"]
)
...
@type_check_only
class _SupportsFileMethodsRW(
    SupportsWrite[bytes], _SupportsFileMethods, Protocol
): ...
...
class _SupportsDLPack(Protocol[_T_contra]):
    def __dlpack__(
        self, /, *, stream: _T_contra | None = None
    ) -> CapsuleType: ...
...
class dtype(Generic[_ScalarT_co], metaclass=_DTypeMeta):
    ...
    @overload
    def __rmul__(
        self: _FlexDTypeT, value: SupportsIndex, /
    ) -> _FlexDTypeT: ...
    @overload
    ...
    def fields(
        ...
        MappingProxyType[
            LiteralString, tuple[dtype, int] | tuple[dtype, int, Any]
        ]
        | None
    ): ...
    @property
...
class _ArrayOrScalarCommon:
    ...
    def round(
        self, /, decimals: SupportsIndex = 0, out: None = None
    ) -> Self: ...
    @overload  # out=ndarray
    def round(self, /, decimals: SupportsIndex, out: _ArrayT) -> _ArrayT: ...
    @overload
    def round(
        self, /, decimals: SupportsIndex = 0, *, out: _ArrayT
    ) -> _ArrayT: ...
    @overload  # out=None (default)
    def choose(
        self,
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeT_co, _DTypeT_co]):
    ...
    @overload
    def tolist(
        self: ndarray[tuple[int], dtype[generic[_T]]], /
    ) -> list[_T]: ...
    @overload
    def tolist(
    ...
    def __complex__(
        self: NDArray[number | np.bool | object_], /
    ) -> complex: ...
    def __len__(self) -> int: ...
    ...
    @overload
    def __lt__(
        self: NDArray[object_], other: object, /
    ) -> NDArray[np.bool]: ...
    @overload
    ...
    def __invert__(
        self: _IntegralArrayT, /
    ) -> _IntegralArrayT: ...  # noqa: PYI019
    ...
    @overload
    def __add__(
        self: NDArray[str_], other: _ArrayLikeStr_co, /
    ) -> NDArray[str_]: ...
    @overload
    def __add__(
        self: ndarray[Any, dtypes.StringDType],
    ...
    def __pow__(
        self: _ArrayFloat64_co,
        other: _ArrayLike[floating[_64Bit]],
        mod: None = None,
        /,
    ) -> NDArray[float64]: ...
    @overload
    ...
    @overload
    def __pow__(
        self: NDArray[object_], other: Any, mod: None = None, /
    ) -> Any: ...
    @overload
    def __pow__(
...
class generic(_ArrayOrScalarCommon, Generic[_ItemT_co]):
    ...
    def all(
        ...
        *,
        where: (
            builtins.bool | np.bool | ndarray[tuple[()], dtype[np.bool]]
        ) = True,
    ) -> np.bool: ...
    @overload
    def all(
...
class bool(generic[_BoolItemT_co], Generic[_BoolItemT_co]):
    ...
    @overload
    def __and__(
        self, other: L[False] | np.bool[L[False]], /
    ) -> np.bool[L[False]]: ...
    @overload
    ...
    @overload
    def __or__(
        self, other: L[True] | np.bool[L[True]], /
    ) -> np.bool[L[True]]: ...
    @overload
...
class object_(_RealMixin, generic):
    ...
    def __abs__(
        self, /
    ) -> object_: ...  # this affects NDArray[object_].__abs__
...
class inexact(
    number[_NBit, _InexactItemT_co], Generic[_NBit, _InexactItemT_co]
):
    @abstractmethod
...
class complexfloating(inexact[_NBit1, complex], Generic[_NBit1, _NBit2]):
    ...
    @overload
    def __init__(
        self, real: _ConvertibleToComplex | None = ..., /
    ) -> None: ...
    @property
...
class complex128(complexfloating[_64Bit, _64Bit], complex):  # type: ignore[misc]
    ...
    @overload
    def __pow__(
        self, other: _Complex128_co, mod: None = None, /
    ) -> complex128: ...
    @overload
    def __pow__(
        self, other: complexfloating[_NBit1, _NBit2], mod: None = None, /
...
class timedelta64(
    _IntegralMixin, generic[_TD64ItemT_co], Generic[_TD64ItemT_co]
):
    @property
    def itemsize(self) -> L[8]: ...
    @property
    ...
    @overload
    def __add__(
        self: timedelta64[None], x: _TD64Like_co, /
    ) -> timedelta64[None]: ...
    @overload
    def __add__(
    ...
    @overload
    def __add__(
        self: timedelta64[_AnyTD64Item],
        x: timedelta64[_AnyTD64Item] | _IntLike_co,
        /,
    ...
    @overload
    def __sub__(
        self: timedelta64[None], b: _TD64Like_co, /
    ) -> timedelta64[None]: ...
    @overload
    def __sub__(
    ...
    def __sub__(
        self: timedelta64[_AnyTD64Item],
        b: timedelta64[_AnyTD64Item] | _IntLike_co,
        /,
    ) -> timedelta64[_AnyTD64Item]: ...
    @overload
    ...
    @overload
    def __rsub__(
        self: timedelta64[None], a: _TD64Like_co, /
    ) -> timedelta64[None]: ...
    @overload
    def __rsub__(
    ...
    def __rsub__(
        self: timedelta64[_AnyTD64Item],
        a: timedelta64[_AnyTD64Item] | _IntLike_co,
        /,
    ) -> timedelta64[_AnyTD64Item]: ...
    @overload
    ...
    @overload
    def __rtruediv__(
        self: timedelta64[dt.timedelta], a: dt.timedelta, /
    ) -> float: ...
    @overload
...
class datetime64(_RealMixin, generic[_DT64ItemT_co], Generic[_DT64ItemT_co]):
    ...
    @overload
    def __init__(
        self: datetime64[_AnyDT64Arg], value: _AnyDT64Arg, /
    ) -> None: ...
    @overload
    def __init__(
    ...
    @overload
    def __add__(
        self: datetime64[None], x: _TD64Like_co, /
    ) -> datetime64[None]: ...
    @overload
    def __add__(
    ...
    @overload
    def __sub__(
        self: datetime64[_AnyDate], x: _AnyDate, /
    ) -> dt.timedelta: ...
    @overload
    def __sub__(
        self: datetime64[None], x: timedelta64, /
    ) -> datetime64[None]: ...
    @overload
    def __sub__(
        self: datetime64[None], x: datetime64, /
    ) -> timedelta64[None]: ...
    @overload
    def __sub__(
        self: datetime64[int], x: timedelta64, /
    ) -> datetime64[int]: ...
    @overload
    def __sub__(
        self: datetime64[int], x: datetime64, /
    ) -> timedelta64[int]: ...
    @overload
    def __sub__(
...
class flexible(
    _RealMixin, generic[_FlexibleItemT_co], Generic[_FlexibleItemT_co]
): ...

class void(flexible[bytes | tuple[Any, ...]]):
    @overload
    def __init__(
        self, value: _IntLike_co | bytes, /, dtype: None = None
    ) -> None: ...
    @overload
...
class bytes_(character[bytes], bytes):
    ...
    @overload
    def __init__(
        self, s: str, /, encoding: str, errors: str = ...
    ) -> None: ...
...
class matrix(ndarray[_2DShapeT_co, _DTypeT_co]):
    ...
    def squeeze(
        self, axis: _ShapeLike | None = None
    ) -> matrix[_2D, _DTypeT_co]: ...

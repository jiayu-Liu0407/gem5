...
_DTypeT_co = TypeVar(
    "_DTypeT_co", bound=np.dtype, default=np.dtype, covariant=True
)

_BoolArrayT = TypeVar("_BoolArrayT", bound=container[Any, np.dtype[np.bool]])
_IntegralArrayT = TypeVar(
    "_IntegralArrayT",
    bound=container[Any, np.dtype[np.bool | np.integer | np.object_]],
)
_RealContainerT = TypeVar(
    ...
    bound=container[
        Any,
        np.dtype[
            np.bool | np.integer | np.floating | np.timedelta64 | np.object_
        ],
    ],
)
...
class container(Generic[_ShapeT_co, _DTypeT_co]):
    ...
    def __init__(
        self,
        /,
        data: container[_ShapeT_co, _DTypeT_co]
    ...
    @overload
    def __setitem__(
        self: container[Any, np.dtype[np.void]],
        key: str | list[str],
        value: object,
        /,
    ) -> None: ...
    ...
    #
    def __neg__(
        self: _NumericContainerT, /
    ) -> _NumericContainerT: ...  # noqa: PYI019
    def __pos__(
        self: _NumericContainerT, /
    ) -> _NumericContainerT: ...  # noqa: PYI019
    def __invert__(
    ...
    @overload
    def __iand__(
        self: _BoolArrayT, other: _ArrayLikeBool_co, /
    ) -> _BoolArrayT: ...
    @overload

...
_MatrixT_co = TypeVar(
    "_MatrixT_co", bound=bool, default=L[False], covariant=True
)
_NDMinT_co = TypeVar("_NDMinT_co", bound=int, default=L[1], covariant=True)
_Trans1DT_co = TypeVar(
    "_Trans1DT_co", bound=int, default=L[-1], covariant=True
)
...
class ndenumerate(Generic[_ScalarT_co]):
    ...
    @overload
    def __new__(
        cls, arr: str | _NestedSequence[str]
    ) -> ndenumerate[np.str_]: ...
    @overload
    def __new__(
        cls, arr: bytes | _NestedSequence[bytes]
    ) -> ndenumerate[np.bytes_]: ...
    @overload
    def __new__(
    ...
    @overload
    def __new__(
        cls, arr: int | _NestedSequence[int]
    ) -> ndenumerate[np.intp]: ...
    @overload
    def __new__(
    ...
    @overload
    def __next__(
        self: ndenumerate[np.object_], /
    ) -> tuple[_AnyShape, Incomplete]: ...
    @overload
...
class AxisConcatenator(
    Generic[_AxisT_co, _MatrixT_co, _NDMinT_co, _Trans1DT_co]
):

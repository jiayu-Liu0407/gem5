...
_W_co = TypeVar(
    "_W_co", bound=_WarnLog | None, default=_WarnLog | None, covariant=True
)
...
class suppress_warnings:
    ...
    def __init__(
        self,
        /,
        forwarding_rule: L["always", "module", "once", "location"] = "always",
    ) -> None: ...
...
def print_assert_equal(
    test_string: str, actual: object, desired: object
) -> None: ...
...
def check_support_sve(
    __cache: list[_T_or_bool] = [],
) -> _T_or_bool: ...  # noqa: PYI063
...
def rundocs(
    filename: StrPath | None = None, raise_on_error: bool = True
) -> None: ...
def measure(

...
@overload
def filled(
    a: ndarray[_ShapeT_co, _DTypeT_co],
...
class MaskedArray(ndarray[_ShapeT_co, _DTypeT_co]):
    ...
    def __setmask__(
        self, mask: _ArrayLikeBool_co, copy: bool = False
    ) -> None: ...
    @property
    ...
    @overload
    def __iadd__(
        self: _MaskedArray[timedelta64 | datetime64],
    ...
    def __imul__(
        self: MaskedArray[
            Any, dtype[integer] | dtype[character] | dtypes.StringDType
        ],
    ...
    @overload
    def __imul__(
        self: _MaskedArray[floating | timedelta64],
    ...
    def nonzero(
        self,
    ) -> tuple[_Array1D[intp], *tuple[_Array1D[intp], ...]]: ...
    ...
    @dtype.setter
    def dtype(
        self: MaskedArray[_AnyShape, _DTypeT], dtype: _DTypeT, /
    ) -> None: ...

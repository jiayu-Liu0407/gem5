...
_VisitFunc: TypeAlias = Callable[
    Concatenate[_VisitItem, list[_VisitItem], _VisitResult, _Tss],
    _VisitItem | None,
]
...
f2pyenhancementspattern: Final[
    tuple[re.Pattern[str], L["f2pyenhancements"]]
] = ...
...
moduleprocedurepattern: Final[
    tuple[re.Pattern[str], L["moduleprocedure"]]
] = ...
...
def appendmultiline(
    group: dict[str, Any], context_name: str, ml: str
) -> None: ...
def cracktypespec0(
...
def getblockname(
    block: Mapping[str, object], unknown: str = "unknown"
) -> str: ...
...
def myeval(
    e: str, g: object | None = None, l: object | None = None
) -> float: ...
...
def expr2name(
    a: str, block: Mapping[str, object], args: list[str] = []
) -> str: ...

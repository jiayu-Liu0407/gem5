...
_NestedString: TypeAlias = (
    str | tuple[_NestedString, ...] | list[_NestedString]
)
...
class RelOp(Enum):
    ...
    @classmethod
    def fromstring(
        cls, s: _RelFortran, language: L[Language.Fortran]
    ) -> RelOp: ...
...
class _FromStringWorker(Generic[_LanguageT_co]):
    ...
    @overload
    def __init__(
        self: _FromStringWorker[L[Language.C]],
        /,
    ...
    @overload
    def process(
        self, /, s: list[str], context: str = "expr"
    ) -> list[Expr | _Pair]: ...
    @overload
    def process(

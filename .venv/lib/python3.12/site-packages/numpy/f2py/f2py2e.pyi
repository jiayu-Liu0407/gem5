...
#
def scaninputline(
    inputline: Iterable[str],
) -> tuple[list[str], dict[str, _Bool]]: ...
def callcrackfortran(
    files: list[str], options: dict[str, bool]
) -> list[dict[str, Any]]: ...
def buildmodules(
    lst: Iterable[Mapping[str, object]],
) -> dict[str, dict[str, Any]]: ...
def dict_append(
    d_out: MutableMapping[_KT, _VT], d_in: Mapping[_KT, _VT]
) -> None: ...
def filter_files(
    prefix: str,
    suffix: str,

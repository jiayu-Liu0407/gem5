...
class TestModuleWithDerivedType(util.F2PyTest):
    ...
    sources = [
        util.getpath("tests", "src", "regression", "mod_derived_types.f90")
    ]
...
class TestLowerF2PYDirectives(util.F2PyTest):
    ...
    sources = [
        util.getpath("tests", "src", "regression", "lower_f2py_fortran.f90")
    ]
...
class TestAssignmentOnlyModules(util.F2PyTest):
    ...
    sources = [
        util.getpath("tests", "src", "regression", "assignOnlyModule.f90")
    ]

...
assert_type(
    np.ma.argmin(MAR_f4, None, None, out=MAR_subclass), MaskedArraySubclass
)
...
assert_type(
    np.ma.argmax(MAR_f4, None, None, out=MAR_subclass), MaskedArraySubclass
)
...
assert_type(
    np.ma.compressed(MAR_i8), np.ndarray[tuple[int], np.dtype[np.int64]]
)
...
assert_type(
    MAR_2d_f4.ravel(), np.ma.MaskedArray[tuple[int], np.dtype[np.float32]]
)
assert_type(
    MAR_1d.ravel(order="A"), np.ma.MaskedArray[tuple[int], np.dtype[Any]]
)
...
assert_type(
    ...
    np.ndarray[tuple[int, int], np.dtype[np.bool]] | np.bool,
)
...
assert_type(
    MAR_2d_f4.mT, np.ma.MaskedArray[tuple[int, int], np.dtype[np.float32]]
)
...
assert_type(
    MAR_2d_f4.T, np.ma.MaskedArray[tuple[int, int], np.dtype[np.float32]]
)

...
assert_type(
    npp.polynomial.polyint(AR_f8, k=AR_c16), npt.NDArray[np.complexfloating]
)
...
assert_type(
    npp.polynomial.polyval(AR_i8, AR_c16), npt.NDArray[np.complexfloating]
)
assert_type(npp.polynomial.polyval(AR_O, AR_O), npt.NDArray[np.object_])

assert_type(
    npp.polynomial.polyval2d(AR_b, AR_b, AR_b), npt.NDArray[np.floating]
)
assert_type(
    npp.polynomial.polyval2d(AR_u4, AR_u4, AR_b), npt.NDArray[np.floating]
)
assert_type(
    npp.polynomial.polyval2d(AR_i8, AR_i8, AR_i8), npt.NDArray[np.floating]
)
assert_type(
    npp.polynomial.polyval2d(AR_f8, AR_f8, AR_i8), npt.NDArray[np.floating]
)
assert_type(
...
assert_type(
    npp.polynomial.polyval3d(AR_b, AR_b, AR_b, AR_b), npt.NDArray[np.floating]
)
assert_type(
...
assert_type(
    npp.polynomial.polyvalfromroots(AR_b, AR_b), npt.NDArray[np.floating]
)
assert_type(
    npp.polynomial.polyvalfromroots(AR_u4, AR_b), npt.NDArray[np.floating]
)
assert_type(
    npp.polynomial.polyvalfromroots(AR_i8, AR_i8), npt.NDArray[np.floating]
)
assert_type(
    npp.polynomial.polyvalfromroots(AR_f8, AR_i8), npt.NDArray[np.floating]
)
assert_type(
...
assert_type(
    npp.polynomial.polyvander(AR_c16, 3), npt.NDArray[np.complexfloating]
)
assert_type(npp.polynomial.polyvander(AR_O, 3), npt.NDArray[np.object_])

assert_type(
    npp.polynomial.polyvander2d(AR_f8, AR_f8, [4, 2]), npt.NDArray[np.floating]
)
assert_type(

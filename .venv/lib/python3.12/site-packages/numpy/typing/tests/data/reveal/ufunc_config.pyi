...
assert_type(
    np.seterrcall(func), Callable[[str, int], Any] | SupportsWrite[str] | None
)
assert_type(
    np.seterrcall(Write()),
    Callable[[str, int], Any] | SupportsWrite[str] | None,
)
assert_type(
    np.geterrcall(), Callable[[str, int], Any] | SupportsWrite[str] | None
)

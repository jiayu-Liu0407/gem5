...
assert_type(
    np.arange(False, True), np.ndarray[tuple[int], np.dtype[np.signedinteger]]
)
...
assert_type(
    np.ones(_shape_2d), np.ndarray[tuple[int, int], np.dtype[np.float64]]
)
assert_type(
    np.ones(_shape_nd), np.ndarray[tuple[int, ...], np.dtype[np.float64]]
)
assert_type(
    np.ones(_shape_1d, dtype=np.int64),
...
assert_type(
    np.full(_shape_0d, i8, dtype=object), np.ndarray[tuple[()], np.dtype]
)

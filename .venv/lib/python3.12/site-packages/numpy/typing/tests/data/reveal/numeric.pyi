...
assert_type(
    np.correlate(B, AR_i8, mode="valid"), npt.NDArray[np.signedinteger]
)
assert_type(
    np.correlate(AR_i8, AR_i8, mode="same"), npt.NDArray[np.signedinteger]
)
...
assert_type(
    np.convolve(AR_i8, AR_i8, mode="same"), npt.NDArray[np.signedinteger]
)
...
assert_type(
    np.tensordot(AR_i8, AR_i8, axes=(0, 1)), npt.NDArray[np.signedinteger]
)

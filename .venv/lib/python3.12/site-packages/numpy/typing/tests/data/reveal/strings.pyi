...
assert_type(
    np.strings.ljust(AR_T, [4, 2, 1], fillchar=["a", "b", "c"]), AR_T_alias
)
...
assert_type(
    np.strings.rjust(AR_T, [4, 2, 1], fillchar=["a", "b", "c"]), AR_T_alias
)
...
assert_type(
    np.strings.count(AR_T, ["a", "b", "c"], end=9), npt.NDArray[np.int_]
)
...
assert_type(
    np.strings.endswith(AR_T, "a", start=[1, 2, 3]), npt.NDArray[np.bool]
)
...
assert_type(
    np.strings.startswith(AR_T, "a", start=[1, 2, 3]), npt.NDArray[np.bool]
)
...
assert_type(
    np.strings.rindex(AR_T, "a", start=[1, 2, 3]), npt.NDArray[np.int_]
)

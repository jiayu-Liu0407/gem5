...
assert_type(
    next(np.ndenumerate(AR_LIKE_f)), tuple[tuple[Any, ...], np.float64]
)
...
assert_type(
    ...
    tuple[slice[int, int, None], slice[None, int, None]],
)
assert_type(
...
assert_type(
    np.s_[0:1, None:3], tuple[slice[int, int, None], slice[None, int, None]]
)
assert_type(
    np.s_[0, 0:1, ..., [0, 1, 3]],
    tuple[Literal[0], slice[int, int, None], EllipsisType, list[int]],

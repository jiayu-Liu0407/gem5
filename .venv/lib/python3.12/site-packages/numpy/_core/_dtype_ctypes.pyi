...
@overload
def dtype_from_ctypes_type(
    t: type[ct.c_int8 | ct.c_byte],
) -> np.dtype[np.int8]: ...
@overload
def dtype_from_ctypes_type(
    t: type[ct.c_uint8 | ct.c_ubyte],
) -> np.dtype[np.uint8]: ...
@overload
def dtype_from_ctypes_type(
    t: type[ct.c_int16 | ct.c_short],
) -> np.dtype[np.int16]: ...
@overload
def dtype_from_ctypes_type(
...
@overload
def dtype_from_ctypes_type(
    t: type[ct.c_int32 | ct.c_int],
) -> np.dtype[np.int32]: ...
@overload
def dtype_from_ctypes_type(
    t: type[ct.c_uint32 | ct.c_uint],
) -> np.dtype[np.uint32]: ...
@overload
def dtype_from_ctypes_type(
...
def _from_ctypes_structure(
    t: type[_ctypes.Structure],
) -> np.dtype[np.void]: ...
